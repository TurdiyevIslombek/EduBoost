...
CREATE TABLE "scheduled_metrics" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"video_id" uuid NOT NULL,
	"target_views" integer DEFAULT 0 NOT NULL,
	"target_likes" integer DEFAULT 0 NOT NULL,
	"applied_views" integer DEFAULT 0 NOT NULL,
	"applied_likes" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "users" (
	...
	"subscriber_count_override" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "videos" (
	...
	"user_id" uuid NOT NULL,
	"category_id" uuid,
	"view_count_override" integer DEFAULT 0 NOT NULL,
	"like_count_override" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "comment-reactions" ADD CONSTRAINT "comment-reactions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "comment-reactions" ADD CONSTRAINT "comment-reactions_comment_id_comments_id_fk" FOREIGN KEY ("comment_id") REFERENCES "public"."comments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "scheduled_metrics" ADD CONSTRAINT "scheduled_metrics_video_id_videos_id_fk" FOREIGN KEY ("video_id") REFERENCES "public"."videos"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
